...
namespace adiar
{
  ...
  //////////////////////////////////////////////////////////////////////////////
  inline bdd::label_t bdd_minvar(const bdd &f)
  { return internal::dd_minvar(f); }

  //////////////////////////////////////////////////////////////////////////////
  /// \brief Get the maximal occurring variable in this BDD.
  //////////////////////////////////////////////////////////////////////////////
  inline bdd::label_t bdd_maxvar(const bdd &f)
