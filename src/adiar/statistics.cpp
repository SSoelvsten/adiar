...
namespace adiar
{
  ...
  void adiar_printstat(std::ostream &o)
  {
    ...
    o << indent << indent << "pushes to bucket        " << indent << stats_priority_queue.push_bucket << endl;
    o << indent << indent << "pushes to overflow      " << indent << stats_priority_queue.push_overflow << endl;
    o << endl;
#endif
