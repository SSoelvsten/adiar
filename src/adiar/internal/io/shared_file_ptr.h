...
{
  //////////////////////////////////////////////////////////////////////////////////////////////////
  /// \brief   Provides shared ownership of a single file. This also includes (thread-safe)
  ///          reference counting and automatic garbage collection.
  ///
  /// \details This is a wrapper on the `adiar::shared_ptr` (which in itself is just a wrapper on
  ///          `std::shared_ptr`) to slightly change its semantics:
  ///          - Default constructor creates a new fresh file rather than being null (TODO: change?)
  ///          - If `const` then not only can the pointer not be moved, but the object underneath is
  ///            `const` too, i.e. read-only.
  ///
  ...
  public:
    ...
    ///
    /// \internal This constructor is part of a larger invariant: "A shared file always is in a
    ///           'valid' state". That is, an algorithm right chooses to crash/throw rather than
    ///           return an error value that may propagate throughout computation (similar to how
    ///           CUDD does). If this should be changed, then all internal functions should be
    ///           changed to use the <tt>make_shared_file</tt> and
  ...
  public:
    ...
    ///         beyond the last reference to it is gone.
    ////////////////////////////////////////////////////////////////////////////////////////////////
