...
namespace adiar
{
  ...
  public:
    zdd_ithvar_policy(zdd::label_type v)
      : var(v)
    {}
  ...
  zdd
  zdd_ithvar(const zdd::label_type var, const generator<zdd::label_type>& dom)
  {
  ...
  zdd
  zdd_ithvar(const zdd::label_type var)
  {
    const internal::shared_file<domain_var> dom = domain_get();
    internal::ifstream<domain_var, true> ds(dom);
  ...
  public:
    zdd_nithvar_policy(zdd::label_type v)
      : var(v)
    {}
  ...
  zdd
  zdd_nithvar(const zdd::label_type var, const generator<zdd::label_type>& dom)
  {
  ...
  zdd
  zdd_nithvar(const zdd::label_type var)
  {
    const internal::shared_file<domain_var> dom = domain_get();
    internal::ifstream<domain_var, true> ds(dom);
  ...
  //////////////////////////////////////////////////////////////////////////////
  zdd
  zdd_singleton(const zdd::label_type label)
  {
  ...
  zdd_top()
  {
    if (!domain_isset()) { return zdd_null(); }
