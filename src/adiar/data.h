...
namespace adiar {
  ...
  //////////////////////////////////////////////////////////////////////////////
  /// \brief   A lambda that takes a label as input and returns some type.
  //////////////////////////////////////////////////////////////////////////////
  template<typename ret_type>
  using label_lambda = std::function<ret_type(label_t)>;

  //////////////////////////////////////////////////////////////////////////////
  /// \brief   Returns true or false based on the label.
  //////////////////////////////////////////////////////////////////////////////
  typedef label_lambda<bool> label_predicate;

  //////////////////////////////////////////////////////////////////////////////
  /// \brief   Returns a substitution action based on the label.
  //////////////////////////////////////////////////////////////////////////////
  enum substitute_act { KEEP, FIX_FALSE, FIX_TRUE };
  typedef label_lambda<substitute_act> act_predicate;

  //////////////////////////////////////////////////////////////////////////////
  /// \brief Accepts even labels.
  //////////////////////////////////////////////////////////////////////////////
  const label_predicate even_pred = [](label_t label) -> bool
  {
    return (label % 2) == 0;
  };

  //////////////////////////////////////////////////////////////////////////////
  /// \brief Accepts odd labels.
  //////////////////////////////////////////////////////////////////////////////
  const label_predicate odd_pred = [](label_t label) -> bool
  {
    return (label % 2) == 1;
  };

  //////////////////////////////////////////////////////////////////////////////
  /// \brief Returns a lambda that accepts labels equal to arg.
  //////////////////////////////////////////////////////////////////////////////
  inline label_predicate eq_pred(label_t arg)
  {
    return [arg](label_t label) -> bool { return label == arg; };
  }

  //////////////////////////////////////////////////////////////////////////////
  /// \brief Returns a lambda that accepts labels less than arg.
  //////////////////////////////////////////////////////////////////////////////
  inline label_predicate lt_pred(label_t arg)
  {
    return [arg](label_t label) -> bool { return label < arg; };
  }

  //////////////////////////////////////////////////////////////////////////////
  /// \brief Returns a lambda that accepts labels less than or equal to arg.
  //////////////////////////////////////////////////////////////////////////////
  inline label_predicate le_pred(label_t arg)
  {
    return [arg](label_t label) -> bool { return label <= arg; };
  }

  //////////////////////////////////////////////////////////////////////////////
  /// \brief Returns a lambda that accepts labels greater than arg.
  //////////////////////////////////////////////////////////////////////////////
  inline label_predicate gt_pred(label_t arg)
  {
    return [arg](label_t label) -> bool { return label > arg; };
  }

  //////////////////////////////////////////////////////////////////////////////
  /// \brief Returns a lambda that accepts labels greater than or equal to arg.
  //////////////////////////////////////////////////////////////////////////////
  inline label_predicate ge_pred(label_t arg)
  {
    return [arg](label_t label) -> bool { return label >= arg; };
  }

  //////////////////////////////////////////////////////////////////////////////
  /// \brief Returns a lambda that accepts labels in the given interval
  //////////////////////////////////////////////////////////////////////////////
  inline label_predicate interval_pred(label_t low_arg, label_t high_arg)
  {
    return [low_arg, high_arg](label_t label) -> bool
    {
      return low_arg <= label && label <= high_arg;
    };
  }
