...
go_bandit([]() {
  describe("adiar/bdd/relprod.cpp", []() {
    ...
    */
    ...
    // Here, they use a zipped variable ordering 'pre' and 'post'
    ...
    */
    ...
    { // Garbage collect early and free write-lock
      ...
      node_writer nw(bryant_fig18_x0);
      nw << n4 << n3 << n2 << n1;
    }
    ...
    */
    ...
    { // Garbage collect early and free write-lock
      ...
      node_writer nw(bryant_fig18_x1);
      nw << n2 << n1;
    }
