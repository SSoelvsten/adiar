  ...
  describe("adiar/bdd/build.cpp", []() {
    ...
    describe("bdd_counter(min_var, max_var, threshold)", [&]() {
      ...
      it("collapses counting to 0 in [10, 10] to ~x10", [&]() {
        ...
        AssertThat(ns.can_pull(), Is().True());
        AssertThat(ns.pull(), Is().EqualTo(node(10, node::MAX_ID, terminal_T, terminal_F)));
        AssertThat(ns.can_pull(), Is().False());
      ...
      it("creates counting to 2 in [2,5]", [&]() {
        ...
        AssertThat(res->width, Is().EqualTo(3u));
      ...
      it("creates counting to 3 in [0,8]", [&]() {
        ...
        AssertThat(res->width, Is().EqualTo(4u));
      ...
      it("creates counting to 4 in [0,4]", [&]() {
        ...
        AssertThat(res->width, Is().EqualTo(2u));
