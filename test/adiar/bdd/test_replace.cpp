    ...
    describe("bdd_replace(const bdd&, <...>)", [&]() {
      ...
      describe("<constant>", [&]() {
        ...
        it("shifts variables in 'BDD 2'", [&]() {
          ...
          // n2
          AssertThat(out_nodes.can_pull(), Is().True());
          AssertThat(out_nodes.pull(), Is().EqualTo(node(5, bdd::max_id - 2, terminal_F, terminal_T)));
    ...
    */
    {
      ...
      // Garbage collect writer to free write-lock
      arc_writer aw(__bdd_x0_unreduced);
    ...
    */
    {
      ...
      // Garbage collect writer to free write-lock
      arc_writer aw(__bdd_3_unreduced);
    ...
    describe("bdd_replace(__bdd&&, <...>, replace_type)", [&]() {
      ...
      it("reduces and maps shifted of variables in 'BDD 2' if 'replace_type' is 'Monotone' [__bdd_2]", [&]() {
        int m_calls          = 0;
        const mapping_type m = [&m_calls](const int x) {
          m_calls++;
          return x + 1;
