go_bandit([]() {
  describe("adiar/zdd/contains.cpp", [&]() {
    ...
    /*
              ...
              F T  T
     */
    const node_t n1_5 = node(3, MAX_ID,   terminal_T,   terminal_T);
    const node_t n1_4 = node(3, MAX_ID-1, terminal_F,   terminal_T);
    const node_t n1_3 = node(2, MAX_ID,   n1_4.uid(), n1_5.uid());
    const node_t n1_2 = node(1, MAX_ID,   terminal_T,   n1_3.uid());
    const node_t n1_1 = node(0, MAX_ID,   n1_2.uid(), n1_3.uid());
    ...
    /*
             ...
             F T  T
     */
    const node_t n2_4 = node(6, MAX_ID,   terminal_T,   terminal_T);
    const node_t n2_3 = node(6, MAX_ID-1, terminal_F,   terminal_T);
    const node_t n2_2 = node(4, MAX_ID,   n2_3.uid(), n2_4.uid());
    const node_t n2_1 = node(2, MAX_ID,   n2_3.uid(), n2_2.uid());
