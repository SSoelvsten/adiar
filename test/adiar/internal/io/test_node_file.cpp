    ...
    describe("node_writer + node_stream", []() {
      describe(".can_pull(), .pull(), .peek()", []() {
        ...
        it("negates pulls on-the-fly", [&]() {
          ...
          AssertThat(ns.can_pull(), Is().True());
          AssertThat(ns.pull(), Is().EqualTo(node(2, 1, node::pointer_type(true), node::pointer_type(false))));
        ...
        it("negates peeks on-the-fly", [&]() {
          ...
          AssertThat(ns.can_pull(), Is().True());
          AssertThat(ns.peek(), Is().EqualTo(node(2, 0, node::pointer_type(false), node::pointer_type(true))));
          ns.pull();

          AssertThat(ns.can_pull(), Is().True());
          AssertThat(ns.peek(), Is().EqualTo(node(2, 1, node::pointer_type(true), node::pointer_type(false))));
          ns.pull();
        ...
        it("shifts pulls on-the-fly [+1]", [&]() {
          ...
          AssertThat(ns.can_pull(), Is().True());
          AssertThat(ns.pull(), Is().EqualTo(node(1, 0, node::pointer_type(3, 0), node::pointer_type(3, 1))));

          AssertThat(ns.can_pull(), Is().True());
          AssertThat(ns.pull(), Is().EqualTo(node(3, 0, node::pointer_type(true), node::pointer_type(false))));

          AssertThat(ns.can_pull(), Is().True());
          AssertThat(ns.pull(), Is().EqualTo(node(3, 1, node::pointer_type(false), node::pointer_type(true))));
        ...
        it("shifts pulls on-the-fly [+1]", [&]() {
          ...
          AssertThat(ns.can_pull(), Is().True());
          AssertThat(ns.peek(), Is().EqualTo(node(1, 0, node::pointer_type(3, 0), node::pointer_type(3, 1))));
          ns.pull();

          AssertThat(ns.can_pull(), Is().True());
          AssertThat(ns.peek(), Is().EqualTo(node(3, 0, node::pointer_type(true), node::pointer_type(false))));
          ns.pull();

          AssertThat(ns.can_pull(), Is().True());
          AssertThat(ns.peek(), Is().EqualTo(node(3, 1, node::pointer_type(false), node::pointer_type(true))));
          ns.pull();
        ...
        it("shifts and negates pulls on-the-fly [+1]", [&]() {
          ...
          AssertThat(ns.can_pull(), Is().True());
          AssertThat(ns.peek(), Is().EqualTo(node(3, 0, node::pointer_type(false), node::pointer_type(true))));
          ns.pull();

          AssertThat(ns.can_pull(), Is().True());
          AssertThat(ns.peek(), Is().EqualTo(node(3, 1, node::pointer_type(true), node::pointer_type(false))));
          ns.pull();
