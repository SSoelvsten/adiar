        ...
        describe("node_t", [&]() {
            ...
            describe("create_node, label_of, id_of", [&]() {
                ...
                it("should create node [label_t, id_t, node_t&, node_t&]", [&]() {
                    const node_t n_child1 = node(3u,12u, terminal_F, terminal_T);
            ...
            it("should sort by label, then by id", [&]() {
                const node_t node_1_2 = node(1u,2u, terminal_F, terminal_T);
                const node_t node_2_1 = node(2u,1u, terminal_T, terminal_F);

                AssertThat(node_1_2 < node_2_1, Is().True());
                AssertThat(node_2_1 > node_1_2, Is().True());

                const node_t node_2_2 = node(2u,2u, terminal_F, terminal_F);
            ...
            it("should be equal by their content", [&]() {
                const node_t node_1_v1 = node(42u,2u, terminal_F, terminal_T);
                const node_t node_1_v2 = node(42u,2u, terminal_F, terminal_T);
            ...
            it("should be unequal by their content", [&]() {
                const node_t node_1 = node(42u,2u, terminal_F, terminal_T);
                const node_t node_2 = node(42u,2u, terminal_F, terminal_F);
                const node_t node_3 = node(42u,3u, terminal_F, terminal_T);
                const node_t node_4 = node(21u,2u, terminal_F, terminal_T);
            ...
            describe("terminal nodes", [&]() {
                const node_t terminal_node_T = node(true);
                const node_t terminal_node_F = node(false);
            ...
            describe("negate (!)", [&]() {
                ...
                it("should negate terminal_ptr children while preserving flags", [&]() {
                    const node_t n = node(2u,2u, terminal_F, flag(terminal_T));
