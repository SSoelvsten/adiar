...
go_bandit([]() {
  describe("adiar/internal/level_merger.h", []() {
    ...
    describe("level_merger<shared_file<label_t>, ...>", [&]() {
      it("can use a single label_file", [&]() {
        ...
        level_merger<adiar::shared_file<ptr_uint64::label_t>, std::less<>, 1> merger;
      ...
      it("can merge two label_files", [&]() {
        ...
        level_merger<adiar::shared_file<ptr_uint64::label_t>, std::less<>, 2> merger;
