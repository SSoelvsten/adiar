...
\todo[inline, caption={Algorithm: Exists}]{
  Can this algorithm be translated in a way, that is not just naively recreating
  the recursive algorithm within the tree traversal?
}
